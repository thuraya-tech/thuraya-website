...
export const en: Strings = {
  ...
  home: {
    ...
    aqlTitle: 'Aql',
    aqlDesc: 'On-prem private AI for Saudi SMEs — Arabic-native, PDPL-compliant by design.',
    aqlLink: 'Learn more',
  ...
  products: {
    title: 'Our Products',
    lead: 'Three complementary platforms covering the infrastructure and AI lifecycle — better together.',
    compareTitle: 'Quick Comparison',
    headers: { feature: 'Feature', qayd: 'Qayd', trace: 'Trace', aql: 'Aql' },
    rows: [
      { f: 'Category', q: 'Infrastructure management', t: 'Observability & monitoring', a: 'Private AI' },
      { f: 'Target audience', q: 'DevOps & infra teams', t: 'SRE & development teams', a: 'SMEs (law firms first)' },
      { f: 'Primary output', q: 'Unified cloud resources', t: 'Logs, metrics, traces', a: 'Chat + RAG + NL→SQL' },
      { f: 'Standard', q: 'Terraform / OpenTofu', t: 'OpenTelemetry', a: 'Qwen / Llama / Jais (open LLMs)' },
      { f: 'Deployment', q: 'Cloud / on-prem / hybrid', t: 'Cloud / on-prem / hybrid', a: 'On-prem only (Phase 1)' },
      { f: 'Compliance', q: 'NDMO / PDPL', t: 'NDMO / PDPL / NCA ECC', a: 'NDMO / PDPL (architecturally compliant)' },
    ],
    betterTogetherTitle: 'Better Together',
    betterTogetherBody: 'Qayd provisions and manages your infrastructure; Trace observes its health and performance; Aql lets your team apply private AI without data ever leaving the building. Three platforms, one Saudi experience.',
  },
  qaydPage: {
  ...
  aqlPage: {
    tagline: 'Private AI inside your organisation — in Arabic.',
    intro: 'Aql is a private-AI platform that runs entirely inside your premises — modern language models, document search, and natural-language data queries, with your data never leaving the building.',
    featuresTitle: 'Key Features',
    features: [
      { title: 'Full Privacy', body: 'All processing on your hardware. No internet egress required, no data sent externally.' },
      { title: 'Arabic-Native', body: 'Qwen 2.5, Llama 3.3, and Jais — paired with a fully localised Open WebUI.' },
      { title: 'Document Search (RAG)', body: 'Retrieval-augmented generation over your firm\'s contracts, regulations, and cases, with cited sources.' },
      { title: 'Natural-Language Queries', body: 'Ask your databases questions in Arabic; Aql translates them into safe, permission-scoped SQL.' },
      { title: 'Compliant by Design', body: 'Architecture aligned with PDPL and NDMO from day one — data never leaves the Kingdom or the office.' },
    ],
    mockupCaption: 'Aql Arabic interface',
    cta: 'Discover Aql',
